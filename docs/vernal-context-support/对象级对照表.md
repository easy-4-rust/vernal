<!-- migration-doc: authority=authoritative canonical=../migration-audit/vernal-context-support.md -->
...
> 合并来源：`vernal-context-support/history/2026-07-30-dd20300d/对象级对照表.md`；Vernal 基线 `dd20300d16a09200bd8a379ff14db1e2da99b67c`。本附录仅保留旧包分组、设计背景和决策轨迹；其中数量、路径、状态及完成标记均不得覆盖上方自动生成事实区。
