...
mod aspectj_transaction_management_configuration;
mod aspectj_jta_transaction_management_configuration;
mod rethrower;
...
pub use aspectj_transaction_management_configuration::AspectJTransactionManagementConfiguration;
pub use aspectj_jta_transaction_management_configuration::AspectJJtaTransactionManagementConfiguration;
