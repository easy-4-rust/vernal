...
impl TypeComparator for StandardTypeComparator {
    ...
    fn compare(&self, left: &TypedValue, right: &TypedValue) -> Result<std::cmp::Ordering, String> {
        ...
        let ordering = match (l, r) {
            (crate::typed_value::ExpressionValue::Int(a), crate::typed_value::ExpressionValue::Int(b)) => a.cmp(b),
            (crate::typed_value::ExpressionValue::Float(a), crate::typed_value::ExpressionValue::Float(b)) => {
                a.partial_cmp(b).unwrap_or(std::cmp::Ordering::Equal)
            }
            (crate::typed_value::ExpressionValue::Int(a), crate::typed_value::ExpressionValue::Float(b)) => {
                (*a as f64).partial_cmp(b).unwrap_or(std::cmp::Ordering::Equal)
            }
            (crate::typed_value::ExpressionValue::Float(a), crate::typed_value::ExpressionValue::Int(b)) => {
                a.partial_cmp(&(*b as f64)).unwrap_or(std::cmp::Ordering::Equal)
            }
            (crate::typed_value::ExpressionValue::String(a), crate::typed_value::ExpressionValue::String(b)) => a.cmp(b),
            (crate::typed_value::ExpressionValue::Boolean(a), crate::typed_value::ExpressionValue::Boolean(b)) => a.cmp(b),
