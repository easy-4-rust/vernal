//! Container 内部方法和 ObjectProvider 的全面覆盖测试。

use std::any::Any;
use std::sync::Arc;

use vernal_beans::{
    BeanFactory, ComponentDefinition, Container, ObjectProvider,
