//! PathPropertyEditor — Spring 风格的路径属性编辑器。
//!
//! 对应 Java 类：`org.springframework.beans.propertyeditors.PathEditor`。
...
impl Default for PathPropertyEditor {
    fn default() -> Self {
        Self::new()
    }
}

impl PropertyEditor for PathPropertyEditor {
