//! CharsetPropertyEditor — Spring 风格的 Charset 属性编辑器。
//!
...
/// Spring 风格的 Charset 属性编辑器。
pub struct CharsetPropertyEditor {
    value: Option<String>,
}

impl CharsetPropertyEditor {
    /// 创建一个新的实例。
    pub fn new() -> Self {
        Self { value: None }
    }
...
impl Default for CharsetPropertyEditor {
    fn default() -> Self {
        Self::new()
    }
}

impl PropertyEditor for CharsetPropertyEditor {
