//! bean_registration_code — 对应 Java 类：org.springframework.beans.factory.aot.BeanRegistrationCode。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanRegistrationCode 类型。
...
impl Default for BeanRegistrationCode { fn default() -> Self { Self::new() } }
