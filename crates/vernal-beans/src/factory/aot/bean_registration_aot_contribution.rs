//! bean_registration_aot_contribution — 对应 Java 类：org.springframework.beans.factory.aot.BeanRegistrationAotContribution。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanRegistrationAotContribution 类型。
...
impl Default for BeanRegistrationAotContribution { fn default() -> Self { Self::new() } }
