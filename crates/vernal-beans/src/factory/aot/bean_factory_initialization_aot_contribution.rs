//! bean_factory_initialization_aot_contribution — 对应 Java 类：org.springframework.beans.factory.aot.BeanFactoryInitializationAotContribution。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanFactoryInitializationAotContribution 类型。
...
impl Default for BeanFactoryInitializationAotContribution { fn default() -> Self { Self::new() } }
