//! autowired_element_resolver — 对应 Java 类：org.springframework.beans.factory.aot.AutowiredElementResolver。

use std::collections::HashMap;
use std::sync::Mutex;

/// AutowiredElement 解析器。
...
impl Default for AutowiredElementResolver { fn default() -> Self { Self::new() } }
