//! bean_definition_method_generator_factory — 对应 Java 类：org.springframework.beans.factory.aot.BeanDefinitionMethodGeneratorFactory。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanDefinitionMethodGenerator 工厂。
...
impl Default for BeanDefinitionMethodGeneratorFactory { fn default() -> Self { Self::new() } }
