//! bean_registrations_code — 对应 Java 类：org.springframework.beans.factory.aot.BeanRegistrationsCode。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanRegistrationsCode 类型。
pub struct BeanRegistrationsCode {
    data: Mutex<HashMap<String, String>>,
}

impl BeanRegistrationsCode {
    /// 创建一个新的实例。
...
impl Default for BeanRegistrationsCode { fn default() -> Self { Self::new() } }
