//! bean_registrations_aot_processor — 对应 Java 类：org.springframework.beans.factory.aot.BeanRegistrationsAotProcessor。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanRegistrationsAotProcessor 类型。
...
impl Default for BeanRegistrationsAotProcessor { fn default() -> Self { Self::new() } }
