//! bean_registration_code_generator — 对应 Java 类：org.springframework.beans.factory.aot.BeanRegistrationCodeGenerator。

use std::collections::HashMap;
use std::sync::Mutex;

/// BeanRegistrationCodeGenerator 类型。
...
impl Default for BeanRegistrationCodeGenerator { fn default() -> Self { Self::new() } }
