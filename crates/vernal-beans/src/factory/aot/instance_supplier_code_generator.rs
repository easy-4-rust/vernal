//! instance_supplier_code_generator — 对应 Java 类：org.springframework.beans.factory.aot.InstanceSupplierCodeGenerator。

use std::collections::HashMap;
use std::sync::Mutex;

/// InstanceSupplierCodeGenerator 类型。
...
impl Default for InstanceSupplierCodeGenerator { fn default() -> Self { Self::new() } }
