//! FileArrayEditor — Spring 风格的文件数组编辑器。
//!
//! 对应 Java 类：`org.springframework.beans.propertyeditors.FileArrayPropertyEditor`。
...
impl Default for FileArrayEditor {
    fn default() -> Self {
        Self::new()
    }
}

impl PropertyEditor for FileArrayEditor {
